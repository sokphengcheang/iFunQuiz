...
import 'package:ifunquiz/src/feature/about/widget/about_page.dart';
...
import 'package:ifunquiz/src/feature/settings/widget/setting_page.dart';
          ...
          onTap: () async {
            ...
            await navigator.pushAndRemoveUntil(
              PageRouteBuilder<void>(
                pageBuilder: (context, _, __) => BlocProvider.value(value: bloc, child: const GamePage()),
