...
class DragSpeedDialController extends ChangeNotifier {
  ...
  static final AnimationController menuAnimationController = AnimationController(
  ...
  Animation<double> menuAnimation(int index) {
    ...
    final animationLengthScale = 1 + ((1 - animationOverlap) * ((dragSpeedDialChildren?.length ?? 0) - 1));
    menuAnimationController.duration = const Duration(milliseconds: 500) * animationLengthScale;
    menuAnimationController.reverseDuration = const Duration(milliseconds: 200) * animationLengthScale;
  ...
  void _setInitialPosition({
    ...
    DragSpeedDialPosition currentInitPosition = initialPosition ?? DragSpeedDialPosition.bottomRight;
  ...
  void onPanUpdate({
    ...
    overlayEntry = null;
    isDragging = true;
    var x = fabPosition.dx + details.delta.dx;
    var y = fabPosition.dy + details.delta.dy;
